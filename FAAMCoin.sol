...
/**
   #FAAM features:
   2.5% fee auto add to the liquidity pool, locked 3 years when selling
   5% fee auto distribute to all holders
   2.5% burned when selling
 */
...
contract FAAMCoin is Context, IERC20, Ownable {
    ...
    string private _name = "Fourty Acres And A Mule";
